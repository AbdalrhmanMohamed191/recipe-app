...
//       return "Invalid Egyptian phone number (010 / 011 / 012 / 015)";
//     return null;
//   };
...
//       const res = await api.post(`/api/v1/${endpoint}`, payload);
...
//       {success && (
//         <div className="alert alert-success p-2 text-center">{success}</div>
//       )}

//       {/* BUTTON */}
//       <button className="btn btn-primary w-100" disabled={loading}>
//         {loading ? "Loading..." : onSignUp ? "Sign Up" : "Sign In"}
//       </button>
